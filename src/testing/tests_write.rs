...
mod test {
    ...
    #[test]
    fn test_error_log() {
        log(crate::logger::log_enum::Log::Error("This is a funny error message "), PathBuf::from("error.log"), None);
    ...
    #[test]
    fn test_print_log() {
        log(crate::logger::log_enum::Log::Print("This is a funny print message "), PathBuf::from("print.log"), None);
    ...
    #[test]
    fn test_warning_log() {
        log(crate::logger::log_enum::Log::Warning("This is a funny warning message "), PathBuf::from("warning.log"), None);
    ...
    fn test_warning_info() {
        log(crate::logger::log_enum::Log::Info("This is a funny warning message "), PathBuf::from("info.log"), None);
    ...
    fn test_log_message_print() {
        log(crate::logger::log_enum::Log::Print("This is a funny print message"), PathBuf::from("print_message.log"), None);
    ...
    fn test_log_message_error() {
        log(crate::logger::log_enum::Log::Error("This is a funny error message"), PathBuf::from("error_message.log"), None);
    ...
    fn test_log_message_warning() {
        log(crate::logger::log_enum::Log::Warning("This is a funny warning message"), PathBuf::from("warning_message.log"), None);
    ...
    #[test]
    fn test_file_log(){
        log(crate::logger::log_enum::Log::Print("This is a funny print message"), PathBuf::from("print_file.log"), None);
